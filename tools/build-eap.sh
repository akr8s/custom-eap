...
#keytool -genseckey -alias vault -storetype jceks -keyalg AES -keysize 128 -storepass vault-xiugaiwo -keypass vault-xiugaiwo -validity 3650 -keystore /opt/jboss/eap/vault/vault.keystore
